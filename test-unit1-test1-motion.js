...
let rs=mount('ring-strain');click(rs,'[data-strain-toggle]');ok('ring-strain motion connects 60-degree cyclopropane to angle strain',/60°.*109\.5.*angle strain/i.test(text(rs,'[data-strain-readout]')));
