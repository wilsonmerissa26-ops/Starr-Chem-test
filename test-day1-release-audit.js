...
var checkPos=gymUiSource.indexOf('function check()'),totalPos=gymUiSource.indexOf('total++;',checkPos),correctPos=gymUiSource.indexOf('correctCount++;',totalPos),scorePos=gymUiSource.indexOf('updateScore();',totalPos);
ok('Math Gym check refreshes score after attempt is recorded',checkPos>=0&&totalPos>checkPos&&correctPos>totalPos&&scorePos>correctPos);
