...
var unicodeNegative=context.window.DrMerissaVoice.normalize('10^−3');ok('voice expands Unicode negative powers before generic minus replacement',unicodeNegative==='ten to the negative 3 power');
